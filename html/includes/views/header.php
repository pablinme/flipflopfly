      ...
      <div class="container">
        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <a class="brand" href="#">flipflopfly</a>
            <div class="nav-collapse collapse">
              <ul class="nav">
              	  <li <?php if($home) echo 'class="active"'; ?>><a href="/">Home</a></li>
              	  <li <?php if($about) echo 'class="active"'; ?>><a href="/about/">About</a></li>
              	  <li <?php if($login) echo 'class="active"'; ?>><a href="/login/" >Sign In</a></li>
			  	  <li <?php if($register) echo 'class="active"'; ?>><a href="/register/">Sign Up</a></li>
              </ul>
